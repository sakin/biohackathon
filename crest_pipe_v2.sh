...
printf [[ $- == *i* ]] && echo 'Interactive' || echo 'Not interactive'

#exit
#cd /home/ubuntu/poetry/poetry-generator
#gen_poem=$(sudo python /home/ubuntu/poetry/poetry-generator/poem_v2.py ${seed_num}) 
#leave me commented out sudo python /home/ubuntu/poetry/poetry-generator/poem_v2.py ${seed_num} > generated_poem.txt
#cd /home/ubuntu/Jons_working_e
